...
$pdf->SetAuthor('Architecture NITTE');
...
and Course_Subjects.Sem='$SSem' and  Student_Info.Section='$SSection' and ";

if($SBranch=="CHE" or $SBranch=="PHY")
{
$sqla =$sqla."Student_Info.Cycle='$SBranch'
ORDER BY Student_Info.C_Roll_Number,Course_Subjects.Hours ASC ";
}
else
{
$sqla =$sqla."Student_Info.Program='$SBranch'
ORDER BY Student_Info.C_USN,Student_Info.C_Roll_Number,Course_Subjects.Hours ASC ";
}
...
//  Kannada Skipping
if(trim($res1->Subject_Code)=="20HU312"){continue;}
...
*/
  if($P_Address!=""){$FinalAddr=$FinalAddr.$P_Address."<br>";}
  if($P_Taluk!=""){ if($P_Taluk=="OTHER"){$P_Taluk="";}    $FinalAddr=$FinalAddr.$P_Taluk.",";}
  if($P_Post!="") { if($P_Post=="OTHER"){$P_Post="";}     $FinalAddr=$FinalAddr.$P_Post."<br>";}
  if($P_District!=""){ if($P_District=="OTHER"){$P_District="";}    $FinalAddr=$FinalAddr.$P_District."<br>";}
  if($P_State!=""){ if($P_State=="OTHER"){$P_State="";}    $FinalAddr=$FinalAddr.$P_State."-";}
  if($P_Pin!=""){$FinalAddr=$FinalAddr.$P_Pin."<br>";}
...
$Par1=$Par1."<table  style=\"font-size:10px;border:1px solid black;\" border=\"1\" cellpadding=\"5\">
	...
	<th style=\"text-align:center;border:1px solid black;width:200px;\"><b>SUBJECTS</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-1</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-2</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-3</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-4</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-5</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-6</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-7</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-8</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-9</b></th>
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>Assignment-10</b></th>
	...
	<th style=\"text-align:center;border:1px solid black;width:45px;\"><b>MSE-3</b></th>
...
<td style=\"text-align:left;\">$s_name</td>";
  ...
  $poor_m2="";$poor_c2;
	$poor_m3="";$poor_c3;
  $tk_1=$tk_2=$tk_3=$tk_4=$tk_5=$tk_6=$tk_7=$tk_8=$tk_9=$tk_10=$ms_1=$ms_2=$ms_3="";
  $tx_1=$tx_2=$tx_3=$tx_4=$tx_5=$tx_6=$tx_7=$tx_8=$tx_9=$tx_10=$mx_1=$mx_2=$mx_3="";
  ...
  foreach($resultsf as $rowd)
  {
   ...
   $exmt=$rowd->Occasion;
   $e_mrk=$rowd->Mark;       //$e_mrk=ltrim($e_mrk, '0');      $e_mrk = rtrim($e_mrk, '.');
   ...
   if($exmt=='TASK_4'){$tk_4=$e_mrk;$tx_4=$mx_mk; if($ck_att=="A"){$tk_4="AB";} }
	 if($exmt=='TASK_5'){$tk_5=$e_mrk;$tx_5=$mx_mk; if($ck_att=="A"){$tk_5="AB";} }
   if($exmt=='TASK_6'){$tk_6=$e_mrk;$tx_6=$mx_mk; if($ck_att=="A"){$tk_6="AB";} }
	 if($exmt=='TASK_7'){$tk_7=$e_mrk;$tx_7=$mx_mk; if($ck_att=="A"){$tk_7="AB";} }
   if($exmt=='TASK_8'){$tk_8=$e_mrk;$tx_8=$mx_mk; if($ck_att=="A"){$tk_8="AB";} }
	 if($exmt=='TASK_9'){$tk_9=$e_mrk;$tx_9=$mx_mk; if($ck_att=="A"){$tk_9="AB";} }
	 if($exmt=='TASK_10'){$tk_10=$e_mrk;$tx_10=$mx_mk; if($ck_att=="A"){$tk_10="AB";} }
   ...
   if($ck_att=="A"){$ms_2="AB";}else{$poor_c2=($ms_2*100)/$mx_2;
	...
	if($exmt=='MSE_3') {$ms_3=$e_mrk;$mx_3=$mx_mk;
	if($ck_att=="A"){$ms_3="AB";}else{$poor_c3=($ms_3*100)/$mx_3;
		 if($poor_c3<50){$poor_m3='*';} } }
 }
