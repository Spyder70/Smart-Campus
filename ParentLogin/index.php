...
if(isset($_POST['Submit']))
{
	...
	$sql ="SELECT * FROM Student_Info WHERE ( Father_Mob=:username  or Mother_Mob=:username  or Student_Mob=:username )
	       and ( C_USN=:password  or  C_Roll_Number=:password )";
...
<body>
	...
	<div class="w3layouts-main">
		...
		<div class="bg-layer">
			...
			<h1><b>
					<marquee class="blink" direction="left" scrollamount="20">Parents&Student Login  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Parents&Student Login &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Parents&Student Login</marquee>
				</b></h1>
			...
			<div class="copyright">
				<p>
					<span>architectureschool@Nmamit : 2023 &hearts; Students MCA</span>
				</p>
