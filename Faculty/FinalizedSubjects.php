...
$PageName="Faculties Subjects List";
...
<form method="post" action="FinalizedSubjects.php" target="_blank">
...
function MakeFz(FsId)
{
	...
	type: 'POST',
	url: 'Ajax/FL_List.php',
	data: {C_Date:val,FsId:FsId,Fetch:val2},
	success:function(data)
		{
		$("#TBY").html(data);
		}
...
function Deallocate(FsId)
{
    var val = $("#C_Date").val();
    var val2="Deallocate";
    if (confirm('Are you Sure ..! \n All Data Linked to His/Her Subject will be Lost')) 
    {
    if(val!="")
    {
    $.ajax({
