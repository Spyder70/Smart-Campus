...
Left JOIN Course_Subjects ON Course_Registration.Sub_ID= Course_Subjects.Sub_ID 
Left JOIN Student_Info ON Course_Registration.Student_ID= Student_Info.Student_ID 
Left JOIN Total_Attendance ON Course_Registration.Student_ID=Total_Attendance.Student_ID and Course_Registration.Sub_ID= Total_Attendance.Sub_ID where (Student_Info.C_USN='$St_usn' or Student_Info.C_Roll_Number='$St_usn') and Course_Subjects.Sem= Student_Info.Sem 
...
{
echo "<br><br><center><h1>Sorry USN Not Found";
}
