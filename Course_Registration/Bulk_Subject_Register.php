...
$PageName="Bulk Subject Registration";
$Course_Registration_Head="menu-open";
$Bulk_CRegistration="active";
...
$("#Sub_type").change(function() 
{
	...
	success:function(data)
     ...
     if(Sub_type=="Core") // go for Core
     {
        ...
        $.ajax({
	type: 'POST',
	url: 'Ajax/BulkCore/Add_Remove_Register.php',
	data: {C_Date:C_Date,Exam_Type:Exam_Type,Sem:Sem,Branch:Branch,Sub_type:Sub_type,Fetch:val2},
	success:function(data)
		{
		 Clr_F();
...
$("#Subject").change(function() 
{
    ...
    $.ajax({
	type: 'POST',
	url: 'Ajax/BulkEle/Add_Remove_Ele.php',
	data: {C_Date:C_Date,Exam_Type:Exam_Type,Sem:Sem,Branch:Branch,Sub_type:Sub_type,Sub_code:Sub_code},
	success:function(data)
		{
...
function ApplyAll() 
{
    ...
    if(Sub_type!="" && Sub_type=="Core") //choosen Core subject 
    {
    $(".se-pre-con").fadeIn();;
    $.ajax({
	type: 'POST',
...
function AdRm_core(stdid) 
{
	...
	type: 'POST',
	url: 'Ajax/BulkCore/Add_Remove_Register.php',
	data: {C_Date:C_Date,Exam_Type:Exam_Type,Sem:Sem,Branch:Branch,Sub_type:Sub_type,Fetch:val2,stdid:stdid},
	success:function(data)
		{
...
function ApplyAllEle() 
{
	...
	type: 'POST',
	url: 'Ajax/BulkEle/Add_Remove_Ele.php',
	data: {C_Date:C_Date,Exam_Type:Exam_Type,Sem:Sem,Branch:Branch,Sub_type:Sub_type,Fetch:val2,Sub_code:Sub_code},
	success:function(data)
		{
		  $(".se-pre-con").fadeOut();;
		 $("#Sub_Table").html(data);
...
function AdRm_Ele(stdid) 
{
    ...
    if(Sub_code!="" && Sub_type!="Core") //choosen elective subject 
    {
    $.ajax({
	type: 'POST',
	url: 'Ajax/BulkEle/Add_Remove_Ele.php',
	data: {C_Date:C_Date,Exam_Type:Exam_Type,Sem:Sem,Branch:Branch,Sub_type:Sub_type,Fetch:val2,Sub_code:Sub_code,stdid:stdid},
	success:function(data)
		{
