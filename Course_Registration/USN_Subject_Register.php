...
$PageName="USN Based Subject Registration";
$Course_Registration_Head="menu-open";
$Ind_CRegistration="active";
...
{
$sql1="select * from Faculty_Subjects where Faculty_ID='$Faculty_ID' and Sub_ID='$Sub_ID' and Course_Date='$C_Date' and Section='$Section'";
$query1 = $dbh->prepare($sql1);
$query1->execute();
$count = $query1->rowCount();
if($count==0)
{
$sql2="insert into Faculty_Subjects (Faculty_ID,Sub_ID,Course_Date,Section,Finalized) values('$Faculty_ID','$Sub_ID','$C_Date','$Section','0')";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		...
		<div class="col-md-2">
		  <div class="form-group">
                   <label>Choose USN</label>
                  
                   <select class="form-control select2"  id="Studid" name="Studid"  required>
                    <option selected="selected"></option>
...
$("#Studid").change(function() 
{
    ...
    var val2="ShowSubjects";
    if(Studid!="" ) //choose USN
    {
    $.ajax({
	type: 'POST',
	url: 'Ajax/USNData_Fetch.php',
	data: {C_Date:C_Date,Exam_Type:Exam_Type,Sem:Sem,Branch:Branch,Studid:Studid,Fetch:val2},
	success:function(data)
		{
		 $("#Sub_Table").html(data);
		}
...
function AdRm_sub(subid) 
{
	...
	type: 'POST',
	url: 'Ajax/USNData_Fetch.php',
	data: {C_Date:C_Date,Exam_Type:Exam_Type,Sem:Sem,Branch:Branch,Studid:Studid,Fetch:val2,subid:subid},
	success:function(data)
		{
		 //$("#Sub_Table").html(data);
		}
