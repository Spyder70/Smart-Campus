...
<!--========== LoGO Start==================-->
        <img src="../images/logo.png" alt="My Logo" class="logo" style=" width: 400px; height: 45px;position: absolute;top: 10px;	right: 10px; bottom: 20px">
        <style>
          .logo {
            width: 300px;
            height: 60px;
...
-->
              <li class="nav-item">
            	 <a href="../Course_Registration/USN_Subject_Register.php" class="nav-link <?php echo $Ind_CRegistration; ?>">
              	    <i class="nav-icon fas fa-user-plus"></i>
                    <p>Individual Registration
                     <!-- <span class="right badge badge-danger">New</span> -->
                    </p>
                </a>
             </li>
